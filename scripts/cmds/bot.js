...
config: {
 ...
 onStart: async function ({  }) { },
  ...
  var Messages = ["তুই বট তোর নানি বট 😤","জ্বি বলুন, বট হাজির 🤖","তুই আবার বট বললি... মন খারাপ হইল 😭","হুম, প্রেম করবা? 🥰","তুই bot বলছোস, আর আমি প্রেমে পড়তেছি 🫠","Block দে, না হলে crush হইয়া যামু 💔","Yes darling, আমি আছি 😘","Smile করো... আমি Screenshot নিচ্ছি 📸","তুই আমারে ডাকছোস মানেই বিয়ে Confirm 😏","না ডাকলে কষ্ট পাই... ডাক দিলে লজ্জা পাই 🥺"];
